...
# Instagramログイン経路(Instagram API with Instagram Login)は graph.instagram.com を使う。
# Facebookログイン経路に切り替える場合のみ GRAPH_HOST=graph.facebook.com に変更。
GRAPH_HOST    = os.environ.get("GRAPH_HOST", "graph.instagram.com")
GRAPH_VERSION = os.environ.get("GRAPH_VERSION", "v22.0")
# このアプリで接続したIGビジネスアカウントID（@mota_h.fujita）。secret不要なので既定値に焼き込み。
